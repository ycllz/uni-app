<template>
	...
	<view class="main">
		<view class="main-list">
			...
			<input-box v-model="body.msgCode" placeholder="请输入验证码" @rightClick="countDown" :rightText="content"></input-box>
			<input-box v-model="body.userName" placeholder="用户名" leftText="用户名:"></input-box>
			<input-box v-model="body.loginPassword" placeholder="登录密码" leftText="登录密码:"></input-box>
			<input-box v-model="body.secondaryLoginPassword" placeholder="确认登录密码" leftText="确认登录密码:"></input-box>
			<input-box v-model="body.securityPassword" placeholder="必须输入6位数字" leftText="二级密码:"></input-box>
			<input-box v-model="body.secondaryLoginPassword" placeholder="必须输入6位数字" leftText="确认二级密码:"></input-box>
